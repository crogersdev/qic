...
helm3 "$CMD" streamx-controller "$TEMPLATE_BASE/streamx-controller" --namespace=go \
  ...
  --set 'envs.controller.OI_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.controller.OI_ORDERING_INGESTION_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.controller.OI_PROTEUS_VERSION2_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.controller.OI_DBHOST=platform.dev.turtle.oi.io' \
  --set 'envs.controller.OI_STREAMX_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.controller.OI_TILE_SERVICE_DBHOST=platform.dev.turtle.oi.io' \
  --set 'envs.controller.OI_TILE_SERVICE_DBPWD=tile_service' \
  --set 'envs.controller.OI_TILE_SERVICE_DBUSER=tile_service' \
  --set 'envs.controller.OI_TILE_SERVICE_DBNAME=tile_service' \
  --set 'envs.controller.OI_TILE_SERVICE_PROD_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.decider.OI_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.decider.OI_ORDERING_INGESTION_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.decider.OI_PROTEUS_VERSION2_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.decider.OI_DBHOST=platform.dev.turtle.oi.io' \
  --set 'envs.decider.OI_STREAMX_DBHOST=platform.dev.turtle.oi.io' \
  ...
  --set 'envs.decider.OI_TILE_SERVICE_DBHOST=platform.dev.turtle.oi.io' \
  --set 'envs.decider.OI_TILE_SERVICE_DBUSER=tile_service' \
  --set 'envs.decider.OI_TILE_SERVICE_DBPWD=tile_service' \
  --set 'envs.decider.OI_TILE_SERVICE_DBNAME=tile_service' \
  --set 'envs.decider.OI_TILE_SERVICE_DEV_DBHOST=platform.dev.turtle.oi.io' \
